...
public class AuthenticationServices : IAuthenticationServices
{
    ...
    public AuthenticationServices(IUsuarioRepository userRepository, IHttpContextAccessor
   httpContextAccessor)
    {
    ...
    public void Logout()
    {
        ...
        // es equivalente a .clear, lo dejo porque capaz en el parcial tenemos que borrar algo en específico (?) dudoso.
